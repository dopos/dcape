...
Примерную схему взаимодействий между приложениями можно посмотреть [тут](https://github.com/dopos/dcape/blob/v3/charts.md#arch)
...
* [linux](https://ubuntu.com/download) + `sudo apt -y install git make sed curl jq bind9-dnsutils`
...
* [Диаграмма первичного развертывания](https://github.com/dopos/dcape/blob/v3/charts.md#install-app-1st-deploy)
* [Диаграмма обновления приложения](https://github.com/dopos/dcape/blob/v3/charts.md#update)
