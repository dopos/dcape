...
* для определения значений параметра можно вызвать внешнюю программу
* для определения значений параметра можно использовать программные конструкции (например, if)
